    ...
    <body>
        ...
        <main>
            ...
            <p class="text-center mt-4">
                <a class="btn btn-success" href="produto_adicionar.php">Adicionar</a>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class='card-body'>
                      ...
                      <div class='row'>
                        ...
                        <div class='col-6'>
                            <a href='bd_remover_produto.php?id=" . $row["id"] . "' class='btn btn-danger'>Excluir</a>
                        </div>
                    </div>
                  </div>
                  </div>
        ...
        <footer>
            <div class="divFooter">
                <div class="divSocial mt-1">
                    <a href="https://www.instagram.com/emporiodasbebidasparacuru/" target="blank"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="black" class="bi bi-instagram" viewBox="0 0 16 16">
