...
<body>
    ...
    <main>
        <h2 class="text-center mt-3">Seja bem-vindo <?php echo $_SESSION['apelido']; ?></h2>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Listagem das categorias dos produtos do sistema</p>
                            <p class="text-center"><a href="../cruds/categorias.php" class="btn btn-success">Ver</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Listagem de todos os produtos cadastrados no sistema</p>
                            <p class="text-center"><a href="../cruds/produtos.php" class="btn btn-success">Ver</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <p class="text-center mt-5 mb-3">
            <a class="btn btn-danger" href="desconectar.php" role="button">
