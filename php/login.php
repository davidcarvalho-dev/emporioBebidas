    ...
    <header>
        ...
        <main>
            ...
            <div class=" container divForm mt-5">
                <form method="POST" action="autenticacao.php" class="mt-5">
                    <h3 class="text-center">Área de Login <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
